...
public class Scacchiera {
    ...
    public static final String ANSI_WHITE_BACKGROUND = "\033[0;107m"; /** Colore bianco per il background*/
    public static final String ANSI_BLUE_BACKGROUND = "\033[0;104m";  /** Colore blu per il background*/
    public static final String ANSI_RESET = "\u001B[0m";  /** Resetta i colori*/
    public static final String ANSI_BLACK = "\u001B[30m";  /** Colore nero per le pedine*/
    // crea la scacchiera
